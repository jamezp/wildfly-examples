 ...
 */
public class DomainServerStartService extends Service<Server> {
    private final Path wildflyHome;
    private final String bindAddress;
    private final long timeout;
    private final OutputStream out;

    public DomainServerStartService(final Path wildflyHome, final String bindAddress, final long timeout, final OutputStream out) {
    ...
    protected Task<Server> createTask() {
        return new Task<Server>() {
            ...
            protected Server call() throws Exception {
                final DomainCommandBuilder commandBuilder = DomainCommandBuilder.of(wildflyHome)
                        ...
                        .addProcessControllerJavaOption("-Dorg.jboss.logmanager.nocolor=true")
                        .addHostControllerJavaOption("-Dorg.jboss.logmanager.nocolor=true");
